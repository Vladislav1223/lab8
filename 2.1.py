...
while count<l and masiv1[count]!=x:  #Вводим линейный поиск
    count+=1
print('Количество сравнений',count+1)  #колличество сравнений,начинается с 0 в шаг 1 значение в нашей задаче необходимо х-1 шагов
if count==l:
    print('Елемента нету')  
else:
...
while count2<l and masiv2[count2]!=x:  #Вводим линейный поиск
    count2+=1
print('Количество сравнений',count2+1)  #колличество сравнений
if count2==l1:
    print('Елемента нету')
else:
